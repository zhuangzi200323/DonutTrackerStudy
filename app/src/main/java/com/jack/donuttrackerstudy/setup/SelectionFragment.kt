 ...
 */
package com.jack.donuttrackerstudy.setup
...
import com.jack.donuttrackerstudy.UserPreferencesRepository
import com.jack.donuttrackerstudy.databinding.FragmentSelectionBinding
...
class SelectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener { button ->
            ...
            selectionViewModel.saveCoffeeTrackerSelection(coffeeSelected, requireContext())
