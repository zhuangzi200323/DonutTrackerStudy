 ...
 */
package com.jack.donuttrackerstudy.coffee
...
import com.jack.donuttrackerstudy.databinding.CoffeeListBinding
...
class CoffeeList : Fragment() {
    ...
    private val adapter = CoffeeListAdapter(
        onEdit = { coffee ->
            var framgent = CoffeeListDirections.actionCoffeeListToCoffeeEntryDialogFragment();
            framgent.setItemId(coffee.id)
